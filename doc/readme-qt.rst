Sficoin-qt: Qt4 GUI for Sficoin
===============================
...
Alternatively, install Qt Creator and open the `Sficoin-qt.pro` file.

An executable named `Sficoin-qt` will be built.
...
A warning for people using the *static binary* version of Sficoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Sficoin is linked against libdb5.3.
...
installed causes Sficoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
